...
if __name__ == "__main__":
    try:
        ...
        parser.add_argument('--start_x', type=float, help='start x point')
        parser.add_argument('--start_y', type=float, help='start y point')
        parser.add_argument('--goal_x', type=float, help='goal x point')
        parser.add_argument('--goal_y', type=float, help='goal y point')
        args = parser.parse_args()

        start_input = (args.start_x, args.start_y)
        goal_input = (args.goal_x, args.goal_y)

        print("input :", start_input, goal_input)
        print("input type :", type(args.start_x), type(goal_input))
        ...
        print("points on map :", start, goal)
        ...
        print("final waypoints :", final_x, final_y)
